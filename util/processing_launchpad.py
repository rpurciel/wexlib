...
#import src.wexlib.model.wrf as wrf
    ...
    if platform == "himawari9" or platform == "himawari8":
        ...
        if product == "download":
            ...
            for time in time_period:
                ...
                bucket_time_str = total_time_calc(tot_time)
                tot_files_all_buckets += num_files
                bucket_times += [tot_time]
                processing_time += tot_time
                processing_time_est = time_remaining_calc(tot_buckets, num_buckets, bucket_times)
            ...
            processing_time_str = total_time_calc(processing_time)
            tot_files_all_buckets += num_files
        ...
        if product == "plot_composite":
            ...
            save_dir = cmd.save_dir.text.strip()
            band_num = int(cmd.band_num.text.strip())
            product = cmd.product.text.strip()
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cmd_file = "/Users/rpurciel/Documents/Cirrus VHMSF Canberra AU/Sat/command_himawari_singleband.xml"
